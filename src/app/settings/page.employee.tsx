        ...
        <div className="bg-[var(--card-bg)] border border-[var(--border-color)] rounded-2xl shadow-md p-8 space-y-8 transition-all duration-300">
          ...
          <section className="space-y-3">
            <button
              ...
              className="w-full flex justify-between items-center px-4 py-3 bg-[var(--background)] border border-[var(--border-color)] rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-800 text-[var(--text-primary)] font-semibold transition-all"
            >
